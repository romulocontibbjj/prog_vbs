...
Begin VB.Form frmServers 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdADDFrom 
         Caption         =   "Adicionar ao Remetente"
         Height          =   300
         Left            =   0
         TabIndex        =   16
         Top             =   0
...
Private WithEvents PrimaryCLS As clsservidores
...
grdDataGrid.Col = 1
s = grdDataGrid.Text
Form1.txtEmail.Text = LCase(e)
Form1.txtServer.Text = LCase("smtp." & s & ".com.br")
End Sub

Private Sub Form_Load()
  Set PrimaryCLS = New clsservidores
...
cmdADDFrom.Move 0, 0, Picture1.ScaleWidth, Picture1.ScaleHeight
End Sub
