...
Begin VB.Form frmButtonTest 
   ...
   Begin VB.PictureBox pProps 
      ...
      Begin VB.Label Label10 
         ...
         Caption         =   $"frmButtonTest.frx":015A
         Height          =   855
         Left            =   120
         TabIndex        =   62
         Top             =   120
   ...
   Begin VB.PictureBox pProps 
      ...
      Begin VB.CheckBox chkShowFocus 
         ...
         Width           =   1695
      End
      Begin VB.CheckBox chkUseCustomColors 
         BackColor       =   &H80000005&
      ...
      Begin VB.ComboBox comCaptionAlign 
         ...
         Width           =   1815
      End
      Begin isButtonTest.isButton cmdChangeIcon 
         Height          =   375
         Left            =   4080
         TabIndex        =   37
         Top             =   960
...
Private Sub chkEnabled_Click()
    cmdArray(0).Enabled = IIf((chkEnabled.Value = vbChecked), True, False)
End Sub

Private Sub chkUseCustomColors_Click()
    cmdArray(0).UseCustomColors = IIf((chkUseCustomColors.Value = vbChecked), True, False)
End Sub
