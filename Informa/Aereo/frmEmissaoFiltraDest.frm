...
Begin VB.Form frmEmissaoFiltraDest 
   ...
   ClientWidth     =   9135
   ControlBox      =   0   'False
   Icon            =   "frmEmissaoFiltraDest.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4395
   ...
   End
End
Attribute VB_Name = "frmEmissaoFiltraDest"
...
X = Flex.Row
    ...
    ElseIf KeyAscii = 13 Then
        With frmEmissao
        .TxtCGCDestinatario = Flex.TextMatrix(X, 0)
        .TxtNomeDestinatario = Flex.TextMatrix(X, 1)
        .TxtCidadeDestinatario = Flex.TextMatrix(X, 2)
        .TxtUFDestinatario = Flex.TextMatrix(X, 3)
        .TxtEndDestinatario.Text = Flex.TextMatrix(X, 4)
        .TxtCEPDestinatario.Text = Flex.TextMatrix(X, 5)
        .TxtTelDestinatario.Text = Flex.TextMatrix(X, 6)
        .TxtFAXDestinatario.Text = Flex.TextMatrix(X, 7)
        .TxtSeguradoraDestinatario.Text = Flex.TextMatrix(X, 8)
        .TxtApoliceDestinatario.Text = Flex.TextMatrix(X, 9)
        .TxtInscrEstDestinatario.Text = Flex.TextMatrix(X, 10)
        End With
        Unload Me
    End If
