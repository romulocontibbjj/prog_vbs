...
Begin VB.Form frmEmissaoBuscaAeroportoDEST 
   ...
   ClientWidth     =   8355
   ControlBox      =   0   'False
   Icon            =   "frmEmissaoBuscaAeroportoDEST.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2115
   ...
   End
End
Attribute VB_Name = "frmEmissaoBuscaAeroportoDEST"
...
X = Flex.Row
    ...
    frmEmissao.TxtSiglaDestinatario = Flex.TextMatrix(X, 0)
    frmEmissao.TxtAeroportoDestinatario = Flex.TextMatrix(X, 2) & " - " & Flex.TextMatrix(X, 1) & " (" & Flex.TextMatrix(X, 3) & ")"
    Unload Me
    End If
End Sub
