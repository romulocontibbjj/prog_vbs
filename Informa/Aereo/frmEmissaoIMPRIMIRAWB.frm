...
With frmEmissao
    ...
    '**********************************lincoln********************************** alterado 13/09/2004
    .Txt_transp.Text = de_informa.rsConsultaAWB.Fields("txtransp")
    '**********************************lincoln********************************** alterado 13/09/2004
...
'**************** Alteraçao - Lincoln  - 13/09/2004 ****************************************************
frmEmissao.Txt_transp.Text = Format(frmEmissao.Txt_transp.Text, "###,###,###,##0.00")
'**************** Alteraçao - Lincoln  - 13/09/2004 ****************************************************
