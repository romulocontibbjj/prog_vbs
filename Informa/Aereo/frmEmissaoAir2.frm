...
de_informa.SelPrecosGERAL xCodTab, xDestino
    ...
    '*************Alteração - Arredondar cálculo p/  duas casas  - Lincoln - 08/09/2004 ***************** Start
    If xTxKgTETC > 0 Then
    ...
    End If
    '*************Alteração - Arredondar cálculo p/  duas casas  - Lincoln - 08/09/2004 ***************** End
...
'***********Alteração - Lincoln - Inclusão de tx transportador **********************Start
If xCodCia = "RG" Then
    If de_informa.rsSel_destino.State = 1 Then
        de_informa.rsSel_destino.Close
    End If
    
    de_informa.Sel_destino TxtCidadeDestinatario.Text
