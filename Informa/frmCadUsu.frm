...
Begin VB.Form frmCadUsu 
   ...
   Begin VB.Frame fraDireitos 
      ...
      Begin TabDlg.SSTab SSTabSistemas 
         ...
         Tab(0).Control(0)=   "FRADireitosInforma1"
         Tab(0).Control(1)=   "FRADireitosInforma2"
         Tab(0).Control(2)=   "FRADireitosInforma3"
         ...
         Tab(3).Control(0)=   "FRADireitosEmissao4"
         Tab(3).Control(0).Enabled=   0   'False
         Tab(3).Control(1)=   "FRADireitosEmissao5"
         Tab(3).Control(1).Enabled=   0   'False
         Tab(3).Control(2)=   "FRADireitosEmissao6"
         ...
         Begin VB.Frame FRADireitosFaturamento3 
            ...
            Begin VB.ComboBox cb_PerfilFat 
               Height          =   315
               ItemData        =   "frmCadUsu.frx":00BB
               Left            =   1200
               List            =   "frmCadUsu.frx":00C8
               TabIndex        =   239
               Text            =   "Perfil de Usuário"
               Top             =   3600
               Width           =   1935
         ...
         Begin VB.Frame FRADireitosInforma1 
            ...
            End
            Begin VB.CheckBox chkDireitos 
               Caption         =   "(Processos) - Consulta Sac Videolar"
               Height          =   195
               Index           =   40
               Left            =   360
               TabIndex        =   121
            ...
            End
            Begin VB.CheckBox chkDireitos 
               Caption         =   "(Processos) - Controle Especial Videolar"
               Height          =   195
               Index           =   43
               Left            =   360
               TabIndex        =   120
            ...
            End
            Begin VB.CheckBox chkDireitos 
               Caption         =   "(Processos) - Cotação de Frete"
               Height          =   195
               Index           =   46
               Left            =   360
               TabIndex        =   119
         ...
         Begin VB.Frame FRADireitosInforma3 
            ...
            Begin VB.ComboBox Combo3 
               Height          =   315
               ItemData        =   "frmCadUsu.frx":00F9
               Left            =   1320
               List            =   "frmCadUsu.frx":0106
               TabIndex        =   144
               Text            =   "Perfil de Usuário"
               Top             =   3600
               Width           =   1935
      ...
      Begin TabDlg.SSTab SSTabSistemas1 
         ...
         TabPicture(0)   =   "frmCadUsu.frx":0127
         ...
         TabPicture(1)   =   "frmCadUsu.frx":0143
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "FRADireitosAereo6"
         Tab(1).Control(1)=   "FRADireitosAereo5"
         Tab(1).Control(2)=   "FRADireitosAereo4"
         Tab(1).ControlCount=   3
         TabCaption(2)   =   "Ordem Serviço"
         TabPicture(2)   =   "frmCadUsu.frx":015F
         Tab(2).ControlEnabled=   0   'False
         ...
         Begin VB.Frame FRADireitosOrdem1 
            ...
            Width           =   3615
            Begin VB.CheckBox chkDireitos 
               Caption         =   "Cancelar Ordem de Serviço"
               ForeColor       =   &H00000000&
               Height          =   195
               Index           =   257
               Left            =   480
         ...
         Begin VB.Frame FRADireitosAereo6 
            ...
            Begin VB.ComboBox cb_perfilaereo 
               Height          =   315
               ItemData        =   "frmCadUsu.frx":017B
               Left            =   1440
               List            =   "frmCadUsu.frx":0188
               TabIndex        =   435
               Text            =   "Perfil de Usuário"
               Top             =   3840
               Width           =   1935
...
Private Sub cmdGravar_Click()
    ...
    Else
        de_informa.Alt_user TxtUsuario, txtNome, Mid(cbFiliais, 1, 2), txtDepartamento, xStatus, xstrdireitos
