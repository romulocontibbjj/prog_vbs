...
Begin VB.Form frmEmissaoBuscaClienteDEST 
   ...
   Icon            =   "frmEmissaoBuscaClienteDEST.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2670
   ...
   End
End
Attribute VB_Name = "frmEmissaoBuscaClienteDEST"
...
X = Flex.Row
    ...
    ElseIf KeyAscii = 13 Then
        ...
        frmEmissao.TxtNomeDestinatario.Text = Flex.TextMatrix(X, 3)
        frmEmissao.TxtCidadeDestinatario.Text = Flex.TextMatrix(X, 4)
        frmEmissao.TxtUFDestinatario.Text = Flex.TextMatrix(X, 5)
        Unload Me
        End If
    End If
