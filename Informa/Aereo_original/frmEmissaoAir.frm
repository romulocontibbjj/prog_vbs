...
TxtTipoTaxa.Text = ""
    ...
    If xTxKgTETC > 0 Then
    xFreteNacional = (xTxKgTETC - ((xTxKgTETC / 100) * xDescTETC)) * xPesoTx
    TxtTipoTaxa.Text = "Específica"
    TxtKiloCob.Text = (xTxKgTETC - ((xTxKgTETC / 100) * xDescTETC))
    Else
    xFreteNacional = (xTxKgGERAL - ((xTxKgGERAL / 100) * xDescGERAL)) * xPesoTx
    TxtTipoTaxa.Text = "Geral"
    TxtKiloCob.Text = (xTxKgGERAL - ((xTxKgGERAL / 100) * xDescGERAL))
    End If
