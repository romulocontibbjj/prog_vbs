...
Begin VB.Form frmButtonTest 
   ...
   Begin VB.PictureBox pProps 
      ...
      Begin VB.Label Label10 
         ...
         Caption         =   $"frmButtonTest.frx":0000
         Height          =   855
         Left            =   120
         TabIndex        =   62
         Top             =   120
   ...
   Begin VB.PictureBox pProps 
      ...
      Begin VB.TextBox txtTTTitle 
         ...
         Width           =   1815
      End
      Begin VB.PictureBox cmdTTForeColor 
         BackColor       =   &H00F0F0F0&
         Height          =   300
         Left            =   4200
         ScaleHeight     =   240
         ...
         Width           =   1455
      End
      Begin VB.PictureBox cmdTTBackColor 
         BackColor       =   &H00F0F0F0&
         Height          =   300
         Left            =   4200
         ScaleHeight     =   240
   ...
   Begin VB.PictureBox pProps 
      ...
      Top             =   2880
      Width           =   6495
      Begin VB.PictureBox cmdFontHighLight 
         BackColor       =   &H00F0F0F0&
         Height          =   300
         Left            =   120
         ScaleHeight     =   240
         ...
         Width           =   1455
      End
      Begin VB.PictureBox cmdFontColor 
         BackColor       =   &H00F0F0F0&
         Height          =   300
         Left            =   120
         ScaleHeight     =   240
         ...
         Width           =   1455
      End
      Begin VB.PictureBox cmdHighLighColor 
         BackColor       =   &H00F0F0F0&
         Height          =   300
         Left            =   120
         ScaleHeight     =   240
         ...
         Width           =   1455
      End
      Begin VB.PictureBox cmdBackColor 
         BackColor       =   &H00F0F0F0&
         Height          =   300
         Left            =   120
         ScaleHeight     =   240
   ...
   Begin VB.PictureBox pProps 
      ...
      Begin VB.ComboBox comCaptionAlign 
         ...
         Width           =   1815
      End
      Begin VB.PictureBox cmdChangeIcon 
         BackColor       =   &H00F0F0F0&
         Height          =   375
         Left            =   4080
         ScaleHeight     =   315
